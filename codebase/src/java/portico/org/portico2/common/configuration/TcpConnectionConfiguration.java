...
import org.portico2.common.network.NetworkUtils;
...
public class TcpConnectionConfiguration extends ConnectionConfiguration
{
	...
	{
		super( name );
		this.type    = ConnectionType.TCP_CLIENT;
	...
	/**
	 * Can be {@link ConnectionType#TCP} or {@link ConnectionType#TCP_SERVER}.
	 */
	...
	{
		if( type != ConnectionType.TCP_SERVER && type != ConnectionType.TCP_CLIENT )
	...
	protected void parseConfiguration( String prefix, Properties properties )
	{
		...
		if( temp != null )
			setType( ConnectionType.fromString(temp) );
