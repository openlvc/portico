...
public class HLA1516eInteger32BE extends HLA1516eDataElement implements HLAinteger32BE
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public HLA1516eInteger32BE()
	{
		this.value = Integer.MIN_VALUE;
	}

	public HLA1516eInteger32BE( int value )
	{
		this.value = value;
	}
	...
	public final void encode( ByteWrapper byteWrapper ) throws EncoderException
	{
		...
		BitHelpers.putIntBE( value, bytes, 0 );
