 ...
 *
 */
package org.portico.lrc.services.time.data;
...
public class TimeStatus implements Externalizable
{
	...
	//                   INSTANCE VARIABLES
	//----------------------------------------------------------
	protected TriState constrained   = TriState.OFF; // is the federate constrained?
	protected TriState regulating    = TriState.OFF; // is the federate regulating?
	protected TAR      advancing     = TAR.NONE;     // the current time advancement request status
	protected double   currentTime   = 0.0;          // the current federate time
	protected double   requestedTime = 0.0;          // the time the federate last requested
	protected double   lookahead     = 0.0;          // the lookahead value for the federate
	protected double   lbts          = 0.0;          // the federate-lbts (requested time+lookahead)
	protected boolean  asynchronous  = false;        // should "HLA messages" be delivered with TAR?
