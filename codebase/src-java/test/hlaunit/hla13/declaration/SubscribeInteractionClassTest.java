...
@Test(sequential=true, groups={"SubscribeInteractionClassTest",
                               "subscribeInteraction",
                               "subscribe",
                               "pubsub",
                               "declarationManagement"})
public class SubscribeInteractionClassTest extends Abstract13Test
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public void testICSubscribe()
	{
		...
		try
		{
			defaultFederate.rtiamb.subscribeInteractionClass( xHandle );
		}
		catch( Exception e )
		{
	...
	public void testICSubscribeWithUndefinedClass()
	{
		try
		{
			defaultFederate.rtiamb.subscribeInteractionClass( 11111111 );
	...
	///////////////////////////////////////////////
	// TEST: testICSubscribeWhenSaveInProgress() //
	///////////////////////////////////////////////
	@Test
	public void testICSubscribeWhenSaveInProgress()
	{
		// resign so we can run the test
	...
	//////////////////////////////////////////////////
	// TEST: testICSubscribeWhenRestoreInProgress() //
	//////////////////////////////////////////////////
	@Test
	public void testICSubscribeWhenRestoreInProgress()
	{
		// resign so we can run the test
	...
	//////////////////////////////////////////////////////
	// TEST: testICPassiveSubscribeWhenSaveInProgress() //
	//////////////////////////////////////////////////////
	@Test
	public void testICPassiveSubscribeWhenSaveInProgress()
	{
		log( "passive subscription not yet supported" );
	}

	/////////////////////////////////////////////////////////
	// TEST: testICPassiveSubscribeWhenRestoreInProgress() //
	/////////////////////////////////////////////////////////
	@Test
	public void testICPassiveSubscribeWhenRestoreInProgress()
	{
		log( "passive subscription not yet supported" );
	}
	...
	public void testICUnsubscribe()
	{
		...
		try
		{
			defaultFederate.rtiamb.unsubscribeInteractionClass( xHandle );
		}
		catch( Exception e )
		{
	...
	public void testICUnsubscribeChildClassDoesntAffectSuperClassSubscription()
	{
		...
		try
		{
			defaultFederate.rtiamb.unsubscribeInteractionClass( yHandle );
		}
		catch( Exception e )
		{
			unexpectedException( "unsubscribing from interaction class", e );
	...
	/////////////////////////////////////////////////
	// TEST: testICUnsubscribeNonSubscribedClass() //
	/////////////////////////////////////////////////
	@Test
	...
	//////////////////////////////////////////////////////////
	// TEST: testICUnsubscribeSuperClassOfSubscribedClass() //
	//////////////////////////////////////////////////////////
	@Test
	...
	public void testICUnsubscribeWithUndefinedClassHandle()
	{
		try
		{
			defaultFederate.rtiamb.unsubscribeInteractionClass( 11111111 );
			expectedException( InteractionClassNotDefined.class );
		}
		catch( InteractionClassNotDefined icnd )
		{
	...
	/////////////////////////////////////////////////
	// TEST: testICUnsubscribeWhenSaveInProgress() //
	/////////////////////////////////////////////////
	@Test
	public void testICUnsubscribeWhenSaveInProgress()
	{
		// resign so we can run the test
		defaultFederate.quickSaveInProgress( "save" );
	...
	////////////////////////////////////////////////////
	// TEST: testICUnsubscribeWhenRestoreInProgress() //
	////////////////////////////////////////////////////
	@Test
	public void testICUnsubscribeWhenRestoreInProgress()
	{
		// resign so we can run the test
		defaultFederate.quickRestoreInProgress( "save" );
