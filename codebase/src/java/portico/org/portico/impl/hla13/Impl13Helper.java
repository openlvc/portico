...
public class Impl13Helper implements ISpecHelper
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public Impl13Helper() throws RTIinternalError
	{
		try
		{
	 ...
	 */
	public void checkSyncAnnounced( String label ) throws SynchronizationLabelNotAnnounced
	{
		try
		{
		...
		{
			throw new SynchronizationLabelNotAnnounced( na.getMessage() );
		}
	}
