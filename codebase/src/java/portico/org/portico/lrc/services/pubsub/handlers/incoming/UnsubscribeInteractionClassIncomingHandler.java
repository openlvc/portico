...
public class UnsubscribeInteractionClassIncomingHandler extends LRCMessageHandler
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public void process( MessageContext context ) throws Exception
	{
		...
		if( logger.isDebugEnabled() )
		{
			...
			logger.debug( "@REMOTE Federate ["+moniker(request)+"] unsubscribed interaction class ["+
