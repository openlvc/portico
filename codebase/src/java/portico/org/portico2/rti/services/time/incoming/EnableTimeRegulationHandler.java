...
public class EnableTimeRegulationHandler extends RTIMessageHandler
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public void process( MessageContext context ) throws JException
	{
		...
		// Send back our reponse and make sure we provide the time we actually assigned
		context.success( newTime );
	}
