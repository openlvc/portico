...
public class HLA1516eObjectInstanceHandleFactory implements ObjectInstanceHandleFactory
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	{
		return HLA1516eHandle.decode( ObjectInstanceHandle.class, buffer, offset );
	}
