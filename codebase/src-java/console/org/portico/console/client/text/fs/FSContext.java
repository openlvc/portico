...
/**
 * Represents a node within the RTI psuedo file system 
 */
public class FSContext
{
	...
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	public static enum ContextType {RTI, Federation, Federate, None};
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public FSContext(String newName, ContextType newType, 
	                 FSContext newParent, Set<String> newValidFiles, ContextType newChildType )
	{
		this.name = newName;
		this.type = newType;
	...
	//----------------------------------------------------------
	/**
	 * @return Returns the value of this context's local name.
	 */
	...
	/**
	 * Returns what context type this context is.
	 */
	...
	/**
	 * Returns what type is allowed to reside under this context
	 */
	...
	/**
	 * Returns a list of psuedo files that are contained within this context.
	 */
	...
	/**
	 * Returns the list of psuedo files that are contained within this context.
	 */
	...
	/**
	 * Returns the absoloute path to this context
	 */
