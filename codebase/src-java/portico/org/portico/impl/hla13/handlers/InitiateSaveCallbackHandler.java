...
/**
 * Generate initiateFederateSave() callbacks to a HLA 1.3 compliant federate ambassador
 */
...
public class InitiateSaveCallbackHandler extends HLA13CallbackHandler
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public void process( MessageContext context ) throws Exception
	{
		...
		// do the callback
		if( isStandard() )
			hla13().initiateFederateSave( label );
		else
			java1().initiateFederateSave( label );
