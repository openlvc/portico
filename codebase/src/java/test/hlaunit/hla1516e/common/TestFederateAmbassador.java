...
import static hlaunit.hla1516e.common.TypeFactory.*;
...
public class TestFederateAmbassador extends NullFederateAmbassador
{
	...
	public void removeObjectInstance( ObjectInstanceHandle theObject,
	                                  ...
	                                  SupplementalRemoveInfo removeInfo )
	{
		this.removeObjectInstance( theObject, tag, sentOrder, theTime, receivedOrder, removeInfo );
	}
	...
	@Override
	public void reflectAttributeValues( ObjectInstanceHandle instance,
	                                    ...
	                                    SupplementalReflectInfo reflectInfo )
	{
		this.reflectAttributeValues( instance, attributes, tag, sentOrder, transport,
		                             time, receivedOrder, reflectInfo );
	}
	...
	@Override
	public void receiveInteraction( InteractionClassHandle clazz,
	                                ...
	                                OrderType rvcOrder,
	                                MessageRetractionHandle retractionHandle,
	                                SupplementalReceiveInfo suppInfo )
	{
		receiveInteraction( clazz, params, tag, sentOrder, transport, time, rvcOrder, suppInfo );
	}
