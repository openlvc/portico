 ...
 */
public class ExtendedSuccessMessage extends ResponseMessage implements Externalizable
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public ExtendedSuccessMessage()
	{
		super( false );
		this.returnValues = new HashMap<String,Object>();
	}
	
	public ExtendedSuccessMessage( HashMap<String,Object> returnValues )
	{
		super( false );
	...
	/**
	 * In each {@link ExtendedSuccessMessage} there is the notion of the "result" object. This is
