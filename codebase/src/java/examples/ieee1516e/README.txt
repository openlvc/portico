...
-------------------------------------------------------------------------------
 ...
 --- JDK Version ---
 Portico has been built against Java 11 and requires a Java 11 JDK to compile
 ...
 not officially supported, and if you are targeting a Java v8 platform, you
 will need to use an older version of Portico.
...
-------------------------------------------------------------------------------
 ...
 of helper scripts have been provided:
   ...
   * linux.sh       // Compile and run on Ubuntu/Rocky
 ...
 Running on Unbuntu/Rocky Linux
 -------------------------------
