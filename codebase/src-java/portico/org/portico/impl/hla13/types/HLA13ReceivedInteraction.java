 ...
 * calls on to it.
 */
public class HLA13ReceivedInteraction implements ReceivedInteraction
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	private HLA13Region region;
	
	//----------------------------------------------------------
	//                      CONSTRUCTORS
	//----------------------------------------------------------

	public HLA13ReceivedInteraction( HashMap<Integer,byte[]> values, RegionInstance region )
	{
		this.values = new HLA13ByteArrayMap( values );
		if( region == null )
			this.region = null;
		else
			this.region = new HLA13Region( region );
	}
