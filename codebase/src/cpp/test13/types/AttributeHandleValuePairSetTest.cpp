 ...
 *
 */
#include "AttributeHandleValuePairSetTest.h"

// Register test suite with the global repository
CPPUNIT_TEST_SUITE_REGISTRATION( AttributeHandleValuePairSetTest );
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION( AttributeHandleValuePairSetTest, "AttributeHandleValuePairSetTest" );
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION( AttributeHandleValuePairSetTest, "types" );

/////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////// Constructors/Destructors /////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
AttributeHandleValuePairSetTest::AttributeHandleValuePairSetTest()
{
...
void AttributeHandleValuePairSetTest::setUp()
{
    this->defaultFederate->quickCreate();
    this->defaultFederate->quickJoin();
    
    this->theSet = RTI::AttributeSetFactory::create(0);
}

void AttributeHandleValuePairSetTest::tearDown()
{
	this->theSet->empty();
	delete this->theSet;
...
// TEST: (valid) testSize() //
//////////////////////////////
void AttributeHandleValuePairSetTest::testSize()
{
...
///////////////////////////////////
void AttributeHandleValuePairSetTest::testGetHandle()
{
	this->theSet->add( 501, "aa", 3 );
	this->theSet->add( 502, "ab", 3 );
	this->theSet->add( 503, "ac", 3 );
...
///////////////////////////////////////////
void AttributeHandleValuePairSetTest::testGetHandleWithInvalidIndex()
{
...
// TEST: (valid) testAdd() //
/////////////////////////////
void AttributeHandleValuePairSetTest::testAdd()
{
...
////////////////////////////////////////
void AttributeHandleValuePairSetTest::testGetValueLength()
{
	this->theSet->add( 501, "one", 4 );
...
//////////////////////////////////
void AttributeHandleValuePairSetTest::testGetValue()
{
	this->theSet->add( 501, "one", 4 );
	this->theSet->add( 502, "theDeuce", 9 );
	this->theSet->add( 503, "trois", 6 );
...
////////////////////////////////
void AttributeHandleValuePairSetTest::testRemove()
{
	this->theSet->add( 501, "one", 4 );
	this->theSet->add( 502, "two", 4 );
...
///////////////////////////////
void AttributeHandleValuePairSetTest::testEmpty()
{
	this->theSet->add( 501, "one", 4 );
	this->theSet->add( 502, "two", 4 );
