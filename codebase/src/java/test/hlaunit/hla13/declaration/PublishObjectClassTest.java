...
public class PublishObjectClassTest extends Abstract13Test
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	 ...
	 */
	private void validatePublished( Test13Federate federate,
	                                int expectedClass,
	 ...
	 */
	private void validateNotPublished( Test13Federate federate,
	                                   int expectedClass,
	...
	/**
	 * This method is like {@link #validateNotPublished(Test13Federate, int, Integer...)}, except
	...
	public void testOCPublish()
	{
		...
		try
		{
			AttributeHandleSet ahs = TestSetup.getRTIFactory().createAttributeHandleSet();
			ahs.add( aaHandle );
			ahs.add( abHandle );
			// do the publication
			defaultFederate.rtiamb.publishObjectClass( aHandle, ahs );
		}
		catch( Exception e )
		{
	...
	public void testOCPublishWithInheritedAttributes()
	{
		...
		try
		{
			...
			ahs.add( bbHandle );
			// do the publication
			defaultFederate.rtiamb.publishObjectClass( bHandle, ahs );
		}
		catch( Exception e )
		{
			unexpectedException( "publishing object attributes", e );
	 ...
	 * published. It is expected that the set of attributes provided to the second publication
	 * will replace the set that was provided to the first.
	 */
	@Test
	public void testOCPublishWithSomeAlreadyPublishedAttributes()
	{
		...
		try
		{
			AttributeHandleSet alteredSet = defaultFederate.createAHS( aaHandle, bbHandle );
			defaultFederate.rtiamb.publishObjectClass( bHandle, alteredSet );
		}
		catch( Exception e )
		{
	...
	public void testOCPublishInheritedAttributesFollowedBySuperClass()
	{
		...
		try
		{
			AttributeHandleSet ahs = defaultFederate.createAHS( aaHandle, abHandle );
			defaultFederate.rtiamb.publishObjectClass( aHandle, ahs );
		}
		catch( Exception e )
		{
	...
	public void testOCPublishWithUndefinedObjectClass()
	{
		try
		{
			...
			ahs.add( aaHandle );
			// do the publication
			defaultFederate.rtiamb.publishObjectClass( -1, ahs );
	...
	public void testOCPublishWithNullHandleSet()
	{
		...
		{
			// do the publication
			defaultFederate.rtiamb.publishObjectClass( aHandle, null );
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	// TEST: testOCPublishForPublishedTypeWithEmptyHandleSetAndOutstandingAcquisitionRequests //
	////////////////////////////////////////////////////////////////////////////////////////////
	/**
	 * Publishing with an empty set is the same as an implicit unpublish. Get an ownership
	 * acquisition request going and then try and publish with an empty set, which should
	 * cause an exception saying there is an outstanding acqusition request so we can't unpublish
	 * (explicitly or implicitly) at this time.
	 */
	@Test
	public void testOCPublishForPublishedTypeWithEmptyHandleSetAndOutstandingAcquisitionRequests()
	{
		// register an object in the second federate so we can request the transfer of some atts
		secondFederate.quickPublish( "ObjectRoot.A.B", "aa", "ab", "ac", "ba", "bb", "bc" );
		int objectHandle = secondFederate.quickRegister( "ObjectRoot.A.B" );
		defaultFederate.quickSubscribe( "ObjectRoot.A.B", "aa", "ab", "ac", "ba", "bb", "bc" );
		defaultFederate.fedamb.waitForDiscovery( objectHandle );
		
		// get a publication up and running first
		defaultFederate.quickPublish( "ObjectRoot.A.B", "aa", "ab", "ac", "ba", "bb", "bc" );
		// request the ownership acquisition
		defaultFederate.quickAcquireRequest( objectHandle, aaHandle, abHandle, acHandle );
		
		// try and republish with empty set. this is an implicit unpublish and should result
		// in an exception because we have an outstanding acquisition request
		try
		{
			AttributeHandleSet ahs = TestSetup.getRTIFactory().createAttributeHandleSet();
			defaultFederate.rtiamb.publishObjectClass( bHandle, ahs );
			expectedException( OwnershipAcquisitionPending.class );
		}
		...
		{
			wrongException( e, OwnershipAcquisitionPending.class );
		}
	}
	
	//////////////////////////////////////////////////////////////////////////////////////////////////
	// TEST: testOCPublishForPublishedTypeWithReducedAttributeSetAndOutstandingAcquisitionRequest() //
	//////////////////////////////////////////////////////////////////////////////////////////////////
	/**
	 * Republishing for an object class will change the existing publication. For example, if you
	 * publish aa, ab and ac and then republish with only aa and ab, ac will be implicitly
	 * unpublished as a result. Get an ownership acquisition request up and going for an attribute
	 * and then implicity unpublish it through a republication without that attribute.
	 */
	@Test
	public void testOCPublishForPublishedTypeWithReducedAttributeSetAndOutstandingAcquisitionRequest()
	{
		// register an object in the second federate so we can request the transfer of some atts
		secondFederate.quickPublish( "ObjectRoot.A.B", "aa", "ab", "ac", "ba", "bb", "bc" );
		int objectHandle = secondFederate.quickRegister( "ObjectRoot.A.B" );
		...
		// republish without acHandle, which is under an active acquisition request
		try
		{
			AttributeHandleSet ahs = defaultFederate.createAHS( aaHandle, abHandle );
			defaultFederate.rtiamb.publishObjectClass( bHandle, ahs );
	...
	/////////////////////////////////////////////
	// TEST: testOCPublishWhenSaveInProgress() //
	/////////////////////////////////////////////
	@Test
	public void testOCPublishWhenSaveInProgress()
	{
		// resign before we run the test
	...
	////////////////////////////////////////////////
	// TEST: testOCPublishWhenRestoreInProgress() //
	////////////////////////////////////////////////
	@Test
	public void testOCPublishWhenRestoreInProgress()
	{
		// resign before we run the test
	...
	public void testOCUnpublish()
	{
		...
		try
		{
			defaultFederate.rtiamb.unpublishObjectClass( aHandle );
		}
		catch( Exception e )
		{
	...
	public void testOCUnpublishWithUndefinedObjectClass()
	{
		try
		{
			defaultFederate.rtiamb.unpublishObjectClass( 11111111 );
			expectedException( ObjectClassNotDefined.class );
		}
		catch( ObjectClassNotDefined ocnd )
		{
	...
	///////////////////////////////////////////////
	// TEST: testOCUnpublishThatIsNotPublished() //
	///////////////////////////////////////////////
	@Test
	...
	///////////////////////////////////////////////////////////////
	// TEST: testOCUnpublishWhileOwnershipAcquisitionIsPending() //
	///////////////////////////////////////////////////////////////
	@Test
	public void testOCUnpublishWhileOwnershipAcquisitionIsPending()
	{
		// set up the required publication and subscription interests, register an object
		// and make sure the default federate finds out about it
		secondFederate.quickPublish( "ObjectRoot.A.B", "aa", "ab", "ac", "ba", "bb", "bc" );
		int objectHandle = secondFederate.quickRegister( "ObjectRoot.A.B" );
		defaultFederate.quickPublish( "ObjectRoot.A.B", "aa", "ab", "ac", "ba", "bb", "bc" );
		defaultFederate.quickSubscribe( "ObjectRoot.A.B", "aa", "ab", "ac", "ba", "bb", "bc" );
		...
		// kick off the ownership transfer request
		defaultFederate.quickAcquireRequest( objectHandle, aaHandle );
	...
	///////////////////////////////////////////////
	// TEST: testOCUnpublishWhenSaveInProgress() //
	///////////////////////////////////////////////
	@Test
	public void testOCUnpublishWhenSaveInProgress()
	{
		// resign before we run the test
		defaultFederate.quickSaveInProgress( "save" );
	...
	//////////////////////////////////////////////////
	// TEST: testOCUnpublishWhenRestoreInProgress() //
	//////////////////////////////////////////////////
	@Test
	public void testOCUnpublishWhenRestoreInProgress()
	{
		// resign before we run the test
		defaultFederate.quickRestoreInProgress( "save" );
