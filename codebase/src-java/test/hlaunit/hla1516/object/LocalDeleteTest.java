 ...
 *
 */
package hlaunit.hla1516.object;
...
@Test(sequential=true, groups={"LocalDeleteTest", "localDelete", "objectManagement"})
public class LocalDeleteTest extends Abstract1516Test
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
