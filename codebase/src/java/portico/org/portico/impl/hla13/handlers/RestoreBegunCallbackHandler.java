...
/**
 * Generates federationRestoreBegun() callbacks to a HLA 1.3 compliant federate ambassador
 */
...
public class RestoreBegunCallbackHandler extends HLA13CallbackHandler
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public void process( MessageContext context ) throws Exception
	{
		...
		if( isStandard() )
			hla13().federationRestoreBegun();
		else
			java1().federationRestoreBegun();
